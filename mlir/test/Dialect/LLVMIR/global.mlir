...
// CHECK: llvm.mlir.global external @absolute_symbol_global() {absolute_symbol = [0 : i64, 42 : i64], addr_space = 0 : i32} : i8
llvm.mlir.global external @absolute_symbol_global() {absolute_symbol = [0 : i64, 42 : i64]} : i8

// CHECK: llvm.mlir.global external @absolute_symbol_full() {absolute_symbol = [-1 : i64, -1 : i64], addr_space = 0 : i32} : i8
